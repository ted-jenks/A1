...
bins, cumulative, popt, error, number, dataMasked = gc.RunSmallImageTest1(method = 'variable',empty = 0.9, minpix = 3, aperture = 13)
...
bins, cumulative, popt, error, number, dataMasked = gc.RunSmallImageTest2(method = 'variable',empty = 0.9, minpix = 3, aperture = 13)
print('Variable:',number, 'objects detected.')
plt.figure()
dataRead = dataMasked.filled(10000)
plt.imshow(dataRead, cmap='gray',norm=LogNorm(vmin = 3455, vmax = 3500))                   #view the image
